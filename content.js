...
const CARDS = [
  ...
  // ── Card 0 · Hero badge ──────────────────────────────────────────────────
  {
    ...
    bio: [
      'I design products & services. I hire, grow, and lead the teams that deliver them at scale — and build the operating frameworks that make design a strategic advantage.',
      'Pre-seeded startups to national institutions. Fintech, investment management, digital banking, commerce, and payments.',
    ],
  ...
  // ── Card 1 · PNB ─────────────────────────────────────────────────────────
  {
    ...
    bio: [
      'Built the CX function from scratch — governance, cross-channel measurement, and departmental ownership of experience as a strategic capability inside a large government-linked institution.',
      'Delivered NPS 66 and a consolidated CSAT baseline of 88.56% across digital, branch, and call centre — the highest in the Malaysian investment fund industry.',
    ],
  ...
  // ── Card 2 · Jewel Digital Ventures ──────────────────────────────────────
  {
    ...
    nameClass: 'name-display-job',
    bio: [
      "Built the product design organisation from zero — hiring a multidisciplinary team of designers, UX researchers, and CX specialists inside the digital arm of Malaysia's largest asset manager.",
      'Delivered end-to-end digital ecosystems across investment platforms, onboarding, and account management — design systems, research frameworks, and moonshot exploration for 30M target users.',
    ],
  ...
  // ── Card 3 · Maybank ─────────────────────────────────────────────────────
  {
    ...
    nameClass: 'name-display-job',
    bio: [
      "Led UX design for MAE and Maybank2U — Malaysia's most widely used consumer banking apps — improving account management, fund transfers, payments, and financial product discovery.",
      'Pioneered lifestyle-centric banking integrating payments, rewards, and everyday activities; drove design system adoption across multiple product verticals, overseeing 11 designers.',
    ],
  ...
  // ── Card 4 · Fave ─────────────────────────────────────────────────────────
  {
    ...
    nameClass: 'name-display-job',
    bio: [
      "Led end-to-end redesign of Fave's consumer and merchant ecosystem across Malaysia, Singapore, and Indonesia — improving discoverability, payment flows, cashback, and merchant dashboards during rapid regional expansion.",
      'Built and scaled the design system and component library; shipped hypothesis-driven discovery and A/B testing frameworks across a fast-growing regional commerce platform.',
    ],
